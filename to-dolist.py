...
def add_task():
    ...
    if task:
        ...
        messagebox.showwarning("Warning", "enter a tasks.")
...
def toggle_task():
    try:
        ...
        messagebox.showwarning("Warning", "select the task you've done.")
...
priority_menu = tk.OptionMenu(window, priority_var, "Low", "Medium", "High","highest")
...
window.mainloop()
https://github.com/Dharavasiyar/codesoft_task1